...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        String name = scanner.next(); // if you want to read the input in String format you will use the .next()
        System.out.println("You have entered the name: " + name);

        // To read integer values from the console/terminal
        System.out.println("Enter Student Age...");
        int age = scanner.nextInt(); // if you want to read the input in INT format you will use the .nextInt()
